...
//    }
//
//    fun runningSuccessfulTests(mapOfMovesAndResults:Map<String,Int>) {
//        for((stringMove,result) in mapOfMovesAndResults){
//            val move:Int = UCI.parseMove(stringMove)
...
//    }
//
//    fun runningFailedTests(arrayOfStringMoves: Array<String>) {
//        for(i in arrayOfStringMoves.indices){
//            val move:Int = UCI.parseMove(arrayOfStringMoves[i])
//
