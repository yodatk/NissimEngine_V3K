...
object UCI {
    ...
    fun parseMove(stringInput:String, board: Board) : Int{
        ...
        val inputSource : Square = Square.fromIntegerToSquare(stringInput[0] - 'a' + (8-(stringInput[1]-'0'))*8)?: throw UCIException("invalid source square: ${stringInput.subSequence(0,1)}")
        val inputTarget : Square = Square.fromIntegerToSquare(stringInput[2] - 'a' + (8-(stringInput[3]-'0'))*8)?: throw UCIException("invalid source square: ${stringInput.subSequence(0,1)}")
